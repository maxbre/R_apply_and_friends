...
- evaluates a function (quite often an anonymous function) over the margins of an array or matrix (which is a special case of 2* matrix) 
...
```{r}
# define a matrix 20*10 filled with normal random numbers
